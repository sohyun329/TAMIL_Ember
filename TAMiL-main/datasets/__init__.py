...
from datasets.utils.continual_dataset import MalwareDataset
from datasets.malware_dataset import MyMalwareDataset  
...
NAMES = {
    ...
    MyMalwareDataset.NAME: MyMalwareDataset
}
